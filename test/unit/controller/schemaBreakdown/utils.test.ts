import {
	createField, createOperationParam,
	createOperations, createSubgraphs,
	createTypes,
	persistEntities
} from "../../../../src/controller/schemaBreakdown/utils";
import {Type} from "../../../../src/model/type";
import {Operation} from "../../../../src/model/operation";
import {DocumentNodeType, EntityType, OperationType} from "../../../../src/model/enums";
...
describe('Help functions for the schema breakdown algorithm', () => {
	...
	test('CreateOperationParam function', () => {
		...
		const response = createOperationParam(data[0].fields[0].arguments[0], parentName, false, {
			dbMap
		} as ITypeDefData)
